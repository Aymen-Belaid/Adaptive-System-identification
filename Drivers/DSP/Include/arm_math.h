...
/*  q31_t r,     s;  without initialisation 'arm_offset_q15 test' fails  but 'intrinsic' tests pass! for armCC */
  ...
  {
    return ((uint32_t)(((((q31_t)x << 16) >> 16) * (((q31_t)y      ) >> 16)) -∞( # (# !#  " .@ü V‡« 
Ïº®b4 &4( & ‡–¿p`P  §Ï T# Í   (]# ö# 0 .@" .`" .Ä" . # V†" ¶§+ ˆ§+ Œ¿" ˆ§+ V‡" ~§+ :AR»¯∆ é’ `H D .: \.
BF`  	¬  $Ì P   * t 4  P  §Ï # Ç   (# #  ù û ·∫ \   * T 4 ≤‡p`§Ï D# Z   (M# X# 0# 6§+ n NE H*,x   1
 #d #4 #“‡¿pP§Ï ê# j   (ô# Æ# P# .– V§+ Ü§+ Ü BÇƒ& p*,F F   :
 ,  ‡–¿p`0P§Ï # ¢   (˘# # ¿∫ .p# 
ÒŒÆ— |    í0E 44'4‡–¿p`P  §Ï D# “  (M# b# ê# .∞# .–# .# X §ÆûÅ:Q Æ    d Rp∞( å# (ï# Ø# 
$ .0$ .`$ .Ä$ .†$ Z à&
7 )t )d )4 ) ‡–¿P  §Ï ‰# Ç   (Ì# # ¿$ .¿ .– .‡$ V§+ ¶§+ ˆ§+ M§+ "v &Bí!
L  ( fr "	 "4 " ‡p`P  ∞( \# (e# z#  % .` .–ù .0§ ¶%8é	Å  ! t	  %	 :%	 `" ! d :%	 ]%	 å# !   :%	 ]%	 å# !    %	 :%	 `" 1 #4 # p`P  §Ï Ù# ä   (˝#  # @% .Pµ .`≤ .0é Ÿt.\ô <   : )4Ç )x ‡–¿p`P  §Ï L # ≤  (U # 2!# V0g .`' ^`¿ .`% .Ä% .ê' V§+ ~†% .êé .y ~¿% .‡% . & .`& .@R .êª V@P .@y ¶‡Q ›ê& 6–& .@R .∞] V@P .∞' ¶‡Q @R 6‡' . (  ' 6@P .‡' .0( Æ ' =
§+ ù
@' 6@V .f .`( Æ@V .ÄN .Ä( V§+ zﬁ élZb
`4T>éÄ&N`zà∞ ^"$4&<Ñ*¶,‹.,,N0244<,=<68,:Ü>@ BéD)F|åJŒH`P`TRV}F8 íVr
FFFJ"L0N:H"R,VBP   # d 4 “p§Ï –!# k   8›!# Ó!# "# – 6§+ f R  ˆ!# xy$ ∞†( µÄ`) 1
V]˛N     RpP0∞( 0"# ):"# F"# ∞ R 6 R Ff  bP0  ∞( `"# ):"# j"# ∞û    d 4 Úp∞( à"# (ë"# °"#  ¢ 6ÄN . ¢ T \$ ^$$ 4 &4& & ‡–¿p`P  §Ï ÿ"# ⁄   (·"# &## * .¿" .`" .0* .P* .p* .ê* V§+ ¶§+ ˆ§+ ç§+ =§+ Ì§+ *Ã48‹å
|I=   `" ,FF
JV  4 “p§Ï l## k   8y## ä## ®## – 6§+ f Y  í## xy$ ∞∞* ±Äp+ =
\0Ó    RpP0∞( »## )“## F"# ∞ Y 6 Y    bP0  ∞( Ù## )“## j"# ∞  4 &40 && ‡–¿p`P  §Ï ($# *  (1$# ±$# 0 , .@, .`, .`P . R . - V§+ ˆ§+ ç§+ MÄ, 6†, .¿, .  .‡, . - V@R . R .†Ø V§+ =§+ Ì§+ ù§+ ]§+ ˝§+ R÷4DÇ\
TXë66YÆÇ=HZI ^"\$\&≈(* ,.0( íJ
FF4.JJVR"F&F     4 “p§Ï $%# k   8y## 1%# ®##  9%# xy$ ∞∞* ±Ä@- = / 4  p`P  $Ì ∞   ! d M	 0M	 l\" !   M	 0M	 l\" !F F‰ 6‘ 1T Ù  N	 {N	 º\" !   Ù  N	 {N	 º\" !    N	 {N	 º\" !   Ù  ‰  ‘  T  N	 {N	 º\" (  ¿P$Ì h   ! d  Q	 7Q	 Ù%# !
 Ù ‰ ‘ t 4 7Q	 HQ	 &# !   7Q	 HQ	 &# !    Q	 7Q	 Ù%# !   d  Q	 7Q	 Ù%# c c‰	 V‘
 Qƒ A4 ¬p`P   bP0  ! ‰ t d PU	 tU	 î&# !   PU	 tU	 î&#  í‡¿`0! T	  V	 FV	 Ã&# ! t FV	 NV	 ‹&# ! ‘ NV	 VV	 &# !   NV	 VV	 &# !   FV	 NV	 ‹&# !    V	 FV	 Ã&# +  `0$Ì h   ! t  X	 kX	 H'# ! T ‰ kX	 îX	 \'# ! Ù ƒ îX	 Y	 p'# !   îX	 Y	 p'# ! x h èY	 ﬁY	 †'# !   èY	 ﬁY	 †'# !   kX	 îX	 \'# !    X	 kX	 H'# *  P  $Ì x   !* *Ù #‰ ‘ ƒ t d 4 †Z	 ⁄Z	 ¯'# !   †Z	 ⁄Z	 ¯'#  Ç¿p0  ! ‰ ‘ d T P]	 á]	 H(# !   P]	 á]	 H(#  ¬‡p0  ! ‘	 ƒ
 d T ¿^	 &_	 à(# !   ‘	  ƒ
  d  T ¿^	 &_	 à(# !   ¿^	 &_	 à(#  B`0  !
 
t T pa	 êa	 Ë(# !   pa	 êa	 Ë(# #	 #b‡–¿p`P0  #	 #¬‡–¿p`P0    ‚p0  $Ì h   ! d T ‰ êg	 øg	 L)# !   êg	 øg	 L)# 4
 &4 &“‡–¿p`P§Ï ∞)# j   (π)# ø)# - Ë ‰  % ¬‡p  $Ì X   ! T 4 –k	 Bl	 »)# !   –k	 Bl	 »)# !   T  4 –k	 Bl	 »)#  r‡P0 4 R‡p`' ä pP0  $Ì @  ! ‰ë dê êp	 ¸p	 8*# !   êp	 ¸p	 8*# .	 t d 4  ‡  §Ï ú*# ã   8©*# ª*# —*# 
 ë .§+ V–ù à √*# xy$ †. =
M48\ï   ≤p$Ì X   ! 4 `u	 £u	 ‡*# !   `u	 £u	 ‡*# ) 4  p  §Ï 0+# ≥   8=+# O+# e+# 
–î .¿. ^¿. à W+# xy$ –‡. M
æ ËIÜ   .	 t d 4  ‡  §Ï ò+# É   8•+# º+# “+#  ë . / V§+ ~0é ∞ 
ƒ+# xy$ †@/ ùâ*6X
89 .	 t d 4  ‡  §Ï R filter.
   ...
   * @param[in]     pCoeffs    points to the filter coefficients.
   * @param[in]     pState     points to the s # ∞ö ÕÓ ä 
 
r0 RpP0! ‰ †i ˆi # ! d ˆi j (# !   ˆi j (# !   d ˆi j (# !   ‰  d †i ˆi # !   ‰ †i ˆi # !   †i ˆi #  B  ∞( ¿# (…# ¥ñ"  .0 A 0x$ ,h% (4V (L ‡–¿p`P  §Ï # 2  (# Q# ê .∞ ^P .˙ .Z V– ~Z ¶êª Œ V .p = V ù 6 & í>(®
ôm"aFÇåj~Aæ2%ˆ    b
–0  !, ,Ù (‰ $ƒ  t d T Äs §s Ä# !   Äs §s Ä#  	. 0  §Ï ‹# b  (°" Â# f  *	 t" d! 4   P  §Ï # ‚   (# 2# 0 .P .p .ê xÄ~ d9í)˛    # h 	0 0  §Ï `# b  (°" i# v¡  4 "T; "4: "2 ‡¿p`  §Ï ò# Ç  (°# ƒ# ¿b F‡b n∞ êò¶– Œ∞f ˆ∞ =
i¬ Ñ .(   = ,tK ,dJ ,4I ,B ‡–¿P  §Ï #   (# T# e 6Z ^ V Ü`V Æ N ÷@R ¯- ç0 Ì 6@R ^e . N *÷ Rf Df Df Xn V
p PŸX5ºXæ r,    4 2p∞( ò# (°# 3" P .¿l !
 ƒ
 t d T 4 pâ üâ 8" !   pâ üâ 8" ! 
  ƒ
  t  d  T  4 pâ üâ 8" "
 "4 "r‡–¿p`P∞( $# (-# 8# ê 6p Za    !
 
t	 d –ë ˜ë P" !   –ë ˜ë P" ! t @í Ií X" ! 4 Ií \í l# !   Ií \í l# !   @í Ií X" 2 !< p0P  §Ï –# ⁄  (’J" Ÿ# ≤:Uåí p"
* ,  4 “p∞( # (mﬂ" # û 6  * 4  P  §Ï 0# Ç   (9# D# Pµ 60é ˙-X ƒ   4 ≤p∞( d# (1)" m# . ∆≈ y T 4 ≤‡p`' d 4 ≤p§Ï ®# Z   (ıN" ±# ‰.  ‡p`P0  §Ï ‘# ä   (›# Ë# `N .∞ ˆ8— + 4  p`P  §Ï # ä   (›# # ¬@’     d	 T 4 2p∞( @# (°" ]n"    - dY 4X T p  §Ï l# ì  8y# å# ≥# Ä¿ .`R n§+ êõ#  
™# xy$ ·p ’Ä∞« Ò º"ô l  b‡p`P0  ∞( ‡# )Í# # ‡M . .0 .P ¶ Œ– .`N .êo ç§+ däÏ 
8Af(*â   - 4 Ú‡p`§Ï P# {   8]# e# z# X 8 m# xy$ ∞« Q
ºN¶ú d   /  ‡p`0  §Ï ®# ´   8µ# Ã# ·# `P .p .‡M Ü`P ∞ 
‘# xy$ ∞« ÓtN†A	Z
ﬁ ">  < +c ‡p`0P§Ï #   (%# O# ê . N .Ÿ ~Ÿ .¿M .‡M ~¿M =§+ Ù  Œm
úH
Å&%t    ) 4 “p`P§Ï à# j   (ë# ¶# ∞ .êÅ .– V§+ òò>B @    2
0∞( »# h°" —# Lx   9	 (í ‡¿p`0P  §Ï ¸# Ç  (# *# Pµ .`≤ ^ .‡M . . N .¿M †÷ R:π ré$
5P   + í p`0  §Ï `# Ç  (i# Ñ#  . N . .‡M .¿M †ê "r&î
    4 rp$Ì 0    4 “‡p`∞( ¿# (…# ﬁ# 0 .P .Ä .† 8ô û.0 "d "4 "Ú‡pP§Ï # r   (# &# ¿ .@N .`≤ Ü§+ ¢ j6|,i l' d 4 rp§Ï T# :   (]# h# ‡ 6§+ 
ò F@ : 6	 %4L %D ‡p`P  §Ï ò#   (°# ⁄# ê .`≤ ^  .  .‡M .Ù ~Ù .@ .p ~p ç§+ "‘ "BZ» Lº dÏ6
µH°›Œ> 2
0∞( # h°" # H0 è p`P0§Ï 8# b  ()c" A# 
† "r"^8	 * ‡¿p`0P  §Ï p# í   (y# ù# pÂ 6∞ . R .– V  ¶  ˛§+ Ó NæpÃ.   8	 * ‡¿p`0P  §Ï ‘# ¢   (›# Ú#   .  V Ã Ü§+  ›"d*.   d T 4 ≤p∞(  # ()# 9# ¿Y .P .‡M P i0   3 %t! %d  %4 % ‡P  §Ï l# ¬   (u# Ä# êo .p  ÚB-ﬁ ö2  4 Rp`P∞( ®# (±# …# `˚ (∞ (nê .§+ eÙ    5 #d #4 # ‡–¿p  §Ï ¸# ´   8	# *# ;# – .PÖ . .  †®æ§+ .§+ 
2# Ä0  =∞ ıú0ˆ
∂>$ DÜ   	 	B  ∞( d# `i# 2 8
 *h	 & ‡p`0P§Ï ê# Ç   (ô4" ô# qI 8
 *h	 & ‡p`0P§Ï ƒ# Ç   (ô4" Õ# q9 :
 ,  ‡–¿p`0P§Ï ¯# ä   (# # pn 6–ù - @™Õ   b‡p`P  ! Ù 4 `Í îÍ # !   `Í îÍ # :
 ,  ‡–¿p`0P§Ï t# ¢   (}# í# pn 60é .pn Ve f B6fJ≠U >:
 ,  ‡–¿p`0P§Ï Ã# ™   (’# Í# pn 6–ù .pn V–W f B>f}U > 4 “‡¿p`∞( # 8Qä" )# :# 1# Ä–© ·h e•™>
∂   2	 $d3 $42 $, ‡pP  §Ï p# R  (y# æ# ê  . ! . ! .@! .`! .Ä! .†! .¿! ç¿  6‡! . " ù¿  ˝§+ ∫ I)%I : , í‡¿p`P0$Ì H    T 4 ≤`/
  } arm_matrix_instance_f32;
